...
public class Controller {
    ...
    ImageView setImage(String imageName, int fitHeight) {
		Image image = new Image("file:src/mines/assets/" + imageName);
    ...
    public void setStage(Stage stage, GridPane root) {
		...
		BackgroundImage myBI= new BackgroundImage(new Image("file:src/mines/assets/bg.gif", root.getWidth(), root.getHeight(), true, true),
